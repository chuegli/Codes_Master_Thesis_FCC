...
smeartool.xVertexSigma =  0.0*units.mm
smeartool.yVertexSigma =  0.0*units.mm
smeartool.zVertexSigma =  0.0*units.mm
smeartool.tVertexSigma = 180.0*units.picosecond

from Configurables import  ConstPtParticleGun
pgun_tool = ConstPtParticleGun()
pgun_tool.PdgCodes = [1000024,-1000024]
...
#
# from Configurables import FastSimpleDigi
# fastdigi = FastSimpleDigi()
# fastdigi.trackHits.Path = "TrackerHits"
# fastdigi.smearedHits.Path = "SmearedTrackerHits"
# fastdigi.readoutName = "TrackerBarrelReadout"
# main.TopAlg += [fastdigi]
...
from Configurables import SimG4CharginoPhysicsTool
geant_physics_list = SimG4CharginoPhysicsTool("PhysicsList")
neutralino_mass  = 3000.0 * units.GeV
average_lifetime = 0.2 * units.ns
geant_physics_list.NeutralinoMass        = neutralino_mass
geant_physics_list.CharginoPlusMass      = neutralino_mass + 165 * units.MeV
geant_physics_list.CharginoMinusMass     = neutralino_mass + 165 * units.MeV
geant_physics_list.NeutralinoLifetime    = -1  # Stable
geant_physics_list.CharginoPlusLifetime  = average_lifetime
geant_physics_list.CharginoMinusLifetime = average_lifetime
...
fastdigi.smearedHits.Path = "SmearedTrackerHits"
fastdigi.readoutName = "TrackerBarrelReadout"
fastdigi.forceShiftR = 50. * units.micrometer #### New FCCSW_3, 50 um is half the sensor thickness, adapt!!!!
main.TopAlg += [fastdigi]
