...
// scp best_kin_short_tot.cc chugli@lxplus.cern.ch:/afs/cern.ch/user/c/chugli/private/fast_sim/code/kinematic_selection/
// root -q best_kin_short_tot.cc
...
void make_wino(double fake_rate){
    ////////////////////////////////////////////////////////////////////////////
    //// Best kinematic selection for wino with 3 TeV:
    double pt_cut  = 1800;
    double met_cut = 4300;
    ...
    make_sign(fake_rate, pt_cut/10, met_cut/10, 0);
    make_sign(fake_rate, pt_cut/10, met_cut/10, 1);
...
void make_sign(double fake_rate, int a, int b, int part){
  ...
  streamObj << fake_rate;
  string fake_rate_s = streamObj.str();
  string myname = "/afs/cern.ch/user/c/chugli/private/fast_sim/txt/kinematic_selection_wino_tot_"+fake_rate_s+".txt";
